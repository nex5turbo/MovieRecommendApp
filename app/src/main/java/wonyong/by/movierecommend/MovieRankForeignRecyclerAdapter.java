...
public class MovieRankForeignRecyclerAdapter extends RecyclerView.Adapter<MovieRankForeignRecyclerAdapter.MyViewHolder> {

    private Constants CONST = new Constants();
    private ArrayList<MovieRankRecyclerData> items;

    public MovieRankForeignRecyclerAdapter(ArrayList<MovieRankRecyclerData> items){
        this.items = items;
    }
    ...
    @Override
    public MovieRankForeignRecyclerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        Context context = parent.getContext();
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        View view = inflater.inflate(R.layout.boxoffice_recycler_item, parent, false);
        MovieRankForeignRecyclerAdapter.MyViewHolder vh = new MovieRankForeignRecyclerAdapter.MyViewHolder(view);

        return vh;
    }

    @Override
    public void onBindViewHolder(MovieRankForeignRecyclerAdapter.MyViewHolder holder, int position){
