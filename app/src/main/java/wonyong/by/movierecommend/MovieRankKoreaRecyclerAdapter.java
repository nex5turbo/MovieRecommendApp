...
public class MovieRankKoreaRecyclerAdapter extends RecyclerView.Adapter<MovieRankKoreaRecyclerAdapter.MyViewHolder> {

    private Constants CONST = new Constants();
    private ArrayList<MovieRankRecyclerData> items;

    public MovieRankKoreaRecyclerAdapter(ArrayList<MovieRankRecyclerData> items){
        this.items = items;
    }
    ...
    @Override
    public MovieRankKoreaRecyclerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        Context context = parent.getContext();
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        View view = inflater.inflate(R.layout.boxoffice_recycler_item, parent, false);
        MovieRankKoreaRecyclerAdapter.MyViewHolder vh = new MovieRankKoreaRecyclerAdapter.MyViewHolder(view);

        return vh;
    }

    @Override
    public void onBindViewHolder(MovieRankKoreaRecyclerAdapter.MyViewHolder holder, int position){
